...
- (void)createBooks {
    ...
    Book *book = [[Book alloc] initWithName:@"IOS编程" authors:authors imageHref:@"http://img5.douban.com/mpic/s9042517.jpg" discription:@"book discription" authorInfo:@"author info" price:@"29.0" publisher:@"publisher" publishDate:@"2013-03-02"];
